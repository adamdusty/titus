...
//     if(NULL != module.handle) {
//         module.initialize   = (titus_initialize_proc)dlsym(module.handle, TITUS_MODULE_INITIALIZE);
//         module.deinitialize = (titus_deinitialize_proc)dlsym(module.handle, TITUS_MODULE_DEINITIALIZE);
//     }
